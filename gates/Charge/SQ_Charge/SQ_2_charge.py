"""
بوابة الدفع: Square Charge $1 (Version 2)
...
async def process_SQ_2_charge(
    ...
    """الدالة الرئيسية لفحص البطاقة عبر بوابة Square Charge $1 (Version 2)."""
    ...
    if any(x in rt_lower for x in ["success", "thank you", "approved", "captured"]):
        ...
        x in rt_lower
        for x in ["insufficient funds", "card_declined", "transaction_declined", "do_not_honor"]
    ):
    ...
    return f"{status_icon} | {cc}|{mes}|{ano}|{cvv}", response_text
